  ...
  return (
    <div className='home'>
      <div className="hero">
        ...
        <p>Welcome to the world's largest cryptocurrency marketplace. Here you can see top 15 cryptocurrency by their rank and marketcap for more you can see in searchbar.<br />By clicking coins you will see more details..</p>
